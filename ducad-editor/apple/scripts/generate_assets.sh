#!/bin/bash
# ==============================================================================
# DUCAD Asset Catalog Generator (Icons & Colors for iOS & macOS)
# ==============================================================================
...
SOURCE_ICON="$EDITOR_DIR/assets/icon.png"
if [ ! -f "$SOURCE_ICON" ]; then
    SOURCE_ICON="$EDITOR_DIR/crates/ducad-app/assets/icon.png"
fi

if [ ! -f "$SOURCE_ICON" ]; then
    echo "[ERROR] Source icon not found at assets/icon.png" >&2
    exit 1
fi
