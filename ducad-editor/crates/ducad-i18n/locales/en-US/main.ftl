...
topbar-search-tooltip = Search & Command Palette (Ctrl/Cmd+Shift+P or Ctrl/Cmd+K)
...
drawing-sheet-bom = Bill of Materials (BOM)
drawing-sheet-bom-tooltip = Toggle Bill of Materials parts list table (ISO 7573)
drawing-sheet-balloons = Part Callout Balloons
drawing-sheet-balloons-tooltip = Toggle circular item callout balloons connected to parts on isometric view
drawing-sheet-add-balloon = Balloon Tool
drawing-sheet-add-balloon-tooltip = Click on isometric view to place part callout balloon (B)
bom-table-title = BILL OF MATERIALS
bom-header-item = ITEM
bom-header-part = PART NAME
bom-header-qty = QTY
bom-header-material = MATERIAL
bom-header-description = DESCRIPTION
bom-add-row = Add Row
bom-delete-row = Delete Row
bom-no-items = No BOM Items
balloon-prompt-place = Click on isometric view to place balloon
...
# Assembly Workspace & Mate Constraints (Phase 12.2)
assembly-tree-title = Assembly Tree & Hierarchy
assembly-tree-empty = No assembly components
assembly-tree-empty-sub = Create instances or add parts to begin assembling
assembly-instance = Part Instance
assembly-sub-assembly = Sub-Assembly
assembly-new-sub = New Sub-Assembly
assembly-add-component = Add Component
assembly-ground = Ground (Lock Position)
assembly-unground = Unground (Free Movement)
assembly-grounded-badge = Grounded
assembly-dof-badge = { $dof } DOF
assembly-fully-constrained = Fully Constrained
assembly-under-constrained = Under-Constrained ({ $dof } DOF)
assembly-mates = Mate Constraints
assembly-no-mates = No mates applied
assembly-solve = Solve & Update Assembly
...
assembly-mate-concentric-desc = Align cylinder axis of shaft with hole
assembly-mate-coincident-desc = Attach two planar faces together
assembly-mate-distance-desc = Set precise distance between planar faces or points
assembly-mate-angle-desc = Set angular rotation between two faces or axes
assembly-flip-alignment = Flip Alignment (Opposite / Aligned)
assembly-lock-rotation = Lock Axial Rotation
assembly-mate-distance-label = Offset Distance:
assembly-mate-angle-label = Angle:
assembly-apply-mate = Apply Mate
assembly-cancel-mate = Cancel
assembly-mate-satisfied = Satisfied
assembly-mate-conflicted = Conflicted
assembly-mate-suppressed = Suppressed
topbar-assembly-tooltip = Assembly Tree & Mates
