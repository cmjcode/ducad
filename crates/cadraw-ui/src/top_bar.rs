            ...
            ui.horizontal(|ui| {
                ...
                if state.is_sketching {
                    ...
                    if state.plane_menu_open {
                        ...
                        egui::Area::new(egui::Id::new("cadraw-topbar-plane-select-popup"))
                            .fixed_pos(menu_pos)
                ...
                ui.menu_button(RichText::new(format!("{} Pengaturan", ICON_SETTINGS)).size(11.5), |ui| {
                    ...
                    ui.separator();
                    ui.menu_button(format!("📏 Satuan ({})", state.current_unit.suffix()), |ui| {
...
fn header_icon_btn(
    ...
    let (bg, icon_color) = if active {
        (active_bg.unwrap_or(ACCENT_BLUE), active_fg.unwrap_or(Color32::WHITE))
    } else {
