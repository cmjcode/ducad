...
//!
//! Widget ini generik terhadap "apa aksinya" — caller (`cadraw-app`)
...
impl CommandPalette {
    ...
    /// case-insensitive sederhana, cukup untuk jumlah aksi CADRAW saat ini
    ...
    pub fn show(&mut self, ctx: &egui::Context, entries: &[(&str, &str)]) -> Option<usize> {
        ...
        egui::Area::new(egui::Id::new("cadraw-command-palette"))
