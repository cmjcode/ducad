...
use cadraw_ui::{SelectedEntityData, ToolbarTool};
use glam::{DVec2, Vec3};
...
pub enum PaletteAction {
    ...
    DeleteSelection,
    ToggleTheme,
    SetSketchPlane(cadraw_render::PlaneKind),
    EnterSketching,
    ExitSketching,
    File(FileOp),
    ClearMeasurements,
...
impl Measurement {
    pub fn label(&self) -> String {
        match self {
            ...
            Measurement::Angle { a, vertex, b } => {
                match cadraw_sketch::measure::angle_degrees(*a, *vertex, *b) {
    ...
    pub fn inline_value(&self, unit: LengthUnit) -> Option<String> {
        match self {
            ...
            Measurement::Angle { a, vertex, b } => cadraw_sketch::measure::angle_degrees(*a, *vertex, *b)
...
pub struct RoundHistory {
    pub base: cadraw_kernel::KernelShape,
